...
unsigned int nStakeTargetSpacing = 2 * 60; // DIFF: 1-minute block spacing
int64 nChainStartTime = 1395387647;
...
// lvyecoin: increasing Nfactor gradually
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MehCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "lvye coin baidu.com";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x132d1e981bbd60917f14ac73bdea8dcf0bc12254472e07f7f287a8a194037a40"));
        block.print();
